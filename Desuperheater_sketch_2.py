...
orientation = st.sidebar.selectbox(
    "Gearbox Orientation",
    orientation_options,
    index=0,  # Speed Increaser (Driver = Gear)
...
with col_amp1:
    amp_1x_gear = st.number_input(
        ...
        min_value=0.00,
        max_value=5.00,
        value=0.20,  # Tooth broken scenario default
        step=0.05,
    ...
    amp_gmf_1 = st.number_input(
        ...
        min_value=0.00,
        max_value=5.00,
        value=1.50,  # Tooth broken scenario default
        step=0.05,
...
with col_amp2:
    amp_1x_pinion = st.number_input(
        ...
        min_value=0.00,
        max_value=5.00,
        value=0.10,  # Tooth broken scenario default
        step=0.05,
